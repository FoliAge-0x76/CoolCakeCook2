...
public static class StringExtensions
{
    ...
    public static string OrbImagePath(this string path) {
        ...
        return Path.Join(MainFile.ResPath, "images", "orbs", "orb.png");
    }
    ...
    public static string ScenePath(this string path) {
        ...
        MainFile.Logger.Info("Could not find scene path: " + path);
        return "res://scenes/orbs/orb_visuals/frost_orb.tscn";
    }
}